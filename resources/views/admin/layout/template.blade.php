...
<!-- Mirrored from prium.github.io/phoenix/v1.18.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Nov 2024 09:31:10 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                        <li class="nav-item">
                            ...
                            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span data-feather="pie-chart"></span>
                                        <a class='text-dark' href="{{ route('add-category') }}">Add Category</a>
                                    </div>
                                </a>
                            ...
                            <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span data-feather="pie-chart"></span>
                                        <a class='text-dark' href="{{ route('dashboard_2') }}">Add Product</a>
                                    </div>
                                </a>
            ...
            <footer class="footer position-absolute">
                <div class="row g-0 justify-content-between align-items-center h-100">
                    <div class="col-12 col-sm-auto text-center">
                        <p class="mb-0 mt-2 mt-sm-0 text-body"> Veer Creation<span
...
<!-- Mirrored from prium.github.io/phoenix/v1.18.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Nov 2024 09:32:30 GMT -->
