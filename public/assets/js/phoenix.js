(function (global, factory) {
    ...
    const orders = [
            ...
            },
            {
                ...
                date: "27/04/2023",
                address:
                    "Lavon Haley, 30998 Adonis Locks McGlynnside, ID 27241",
                deliveryType: "Free Shipping",
                status: "Pending",
                badge: { type: "warning", icon: "fas fa-stream" },
                amount: "$70",
            ...
            },
            {
                ...
                date: "26/04/2023",
                address:
                    "Estell Nienow, 4167 Laverna Manor Marysemouth, NV 74590",
                deliveryType: "Free Shipping",
                status: "Completed",
                badge: { type: "success", icon: "fas fa-check" },
                amount: "$59",
            ...
            },
            {
                ...
                date: "23/04/2023",
                address:
                    "Estell Pollich, 13572 Kurt Mews South Merritt, IA 52491",
                deliveryType: "Free Shipping",
                status: "On Hold",
                badge: { type: "secondary", icon: "fas fa-ban" },
                amount: "$49",
            },
            {
                ...
                date: "23/04/2023",
                address:
                    "Ara Mueller, 91979 Kohler Place Waelchiborough, CT 41291",
                deliveryType: "Flat Rate",
                status: "On Hold",
                badge: { type: "secondary", icon: "fas fa-ban" },
                amount: "$19",
            ...
            if (a) {
                ...
                l.on("updated", (e) => {
                    const o =
                        ...
                        document.getElementById(d.fallback);
                    o &&
                ...
                let u = Math.ceil(p / c),
                    ...
                    f = 1;
                m &&
                    m.addEventListener("search.close", () => l.fuzzySearch(""));
                const w = () => {
            ...
            (c.scrollTop = c.scrollHeight),
                t.forEach((t) =>
                    t.addEventListener("shown.bs.tab", () => {
                        ...
                        a.filter(
                            (e) => "all" === c || e.elm.classList.contains(c)
                        );
                    })
                );
        }
    ...
    const createBoardInit = () => {
        ...
        if (i) {
            ...
            document
                .querySelector("#customColorInput")
                    ...
                    e.on("load", () => {
                        e.addSource("earthquakes", {
                            ...
                            e.on("click", "unclustered-point", (t) => {
                                const o =
                                        t.features[0].geometry.coordinates.slice(),
                                    { mag: r } = t.features[0].properties,
                                    s =
                                        1 === t.features[0].properties.tsunami
                                            ? "yes"
                                            : "no";
                                ...
                                new window.mapboxgl.Popup()
                                    .setLngLat(o)
                                    .setHTML(
                                        `magnitude: ${r}<br>Was there a tsunami?: ${s}`
                                    )
                                    .addTo(e);
                            }),
